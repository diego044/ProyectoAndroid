...
public class RegRemitenteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_reg_remitente, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialogBuilder
                        .setMessage("¿Registrar remitente?")
                        .setCancelable(false)
