...
public class DetailRemitenteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_detail_remitente, container, false);
        ...
        Picasso.with(getContext()).load(R.drawable.remitente).into(imagen_1);
        ...
        remitente_id =  this.getArguments().getString("remit_id");
        String remitente_nom =  this.getArguments().getString("remit_nom");
        String remitente_ap =  this.getArguments().getString("remit_ap");
        String remitente_direc =  this.getArguments().getString("remit_direc");
        String remitente_nro_doc =  this.getArguments().getString("remit_nro_doc");
        String remitente_doc =  this.getArguments().getString("remit_doc");
        String remitente_correo =  this.getArguments().getString("remit_correo");
        String remitente_cell =  this.getArguments().getString("remit_cell");
        ...
        Toast.makeText(getContext()," Remitente: " + remitente_nom + " " + remitente_ap,Toast.LENGTH_SHORT).show();
    ...
    public void delDatos(){
        ...
        databaseReference.child(mColeccion).child(remitente_id).removeValue();
